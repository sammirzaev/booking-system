                ...
                <div class="owl-carousel2">
                    <div class="item">
                        <div class="testimony text-center">
                            ...
                            <blockquote>
                                <p> A small river named Amu Darya flows by their place and supplies it with the necessary regelialia.</p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="item">
                        <div class="testimony text-center">
                            ...
                            <blockquote>
                                <p>One day however a small line of blind text by the name of Uzb decided to leave for the far World of Grammar.</p>
                            </blockquote>
                        </div>
                    </div>
                    <div class="item">
