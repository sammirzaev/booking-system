        ...
        <div class="search-wrap">
            <div class="container">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="{{ route('car.index') }}"><i class="flaticon-car"></i> {{ __('layouts/reservation/widget.nav_tab_cars') }} </a></li>
{{--                    <li><a data-toggle="tab" href="#"><i class="flaticon-car"></i> {{ __('layouts/reservation/widget.nav_tab_cars') }} </a></li>--}}
